...
@NgModule({
  declarations: [Example1Component, Example2PipesComponent, Example3Component, Example4Component, Example5Component, Example6Component, Example7Component, Example8Component],
  imports: [
    CommonModule,
